---------------------------------------------------------------------------------------------------
-- func: fight
-- desc: Toggles a mode on the player, granting them several special abilities.
---------------------------------------------------------------------------------------------------
...
function onTrigger(player)
    if (player:getVar("FightMode") == 0) then
        -- Toggle GodMode on..
        player:setVar("FightMode", 1);
